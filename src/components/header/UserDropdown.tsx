...
export default function UserDropdown() {
  ...
  return (
    <div className="relative">
      ...
      >
        <span className="mr-3 overflow-hidden rounded-full h-11 w-11 flex items-center justify-center bg-gray-300 dark:bg-gray-700 text-gray-800 dark:text-white text-lg font-semibold">
          {initials}
        </span>
      ...
      >
        ...
        <div>
          ...
          <span className="mt-0.5 block text-theme-xs text-gray-500 dark:text-gray-400 capitalize">
            {user.role}
          </span>
        </div>
